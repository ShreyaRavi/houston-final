...
public class GearPipeline implements VisionPipeline {
	...
	@Override	public void process(Mat source0) {
		...
		Point cvRectangle0Pt1 = new Point(0, 0);
		Point cvRectangle0Pt2 = new Point(0, 0);
		Scalar cvRectangle0Color = new Scalar(0.0, 0.0, 0.0, 0.0);
		double cvRectangle0Thickness = 110.0;
		int cvRectangle0Linetype = Core.LINE_8;
		double cvRectangle0Shift = 0;
		...
		// Step New_Point0:
		double newPointX = 320.0;
		double newPointY = 0.0;
		newPoint(newPointX, newPointY, newPointOutput);

		// Step CV_rectangle1:
		Mat cvRectangle1Src = cvRectangle0Output;
		Point cvRectangle1Pt1 = new Point(0, 0);
		Point cvRectangle1Pt2 = newPointOutput;
		Scalar cvRectangle1Color = new Scalar(0.0, 0.0, 0.0, 0.0);
		double cvRectangle1Thickness = 110.0;
		int cvRectangle1Linetype = Core.LINE_8;
		double cvRectangle1Shift = 0;
		...
		// Step Blur0:
		Mat blurInput = cvRectangle1Output;
		...
		double[] hslThresholdHue = {58.273381294964025, 98.60068259385666};
		double[] hslThresholdSaturation = {153.64208633093523, 255.0};
		double[] hslThresholdLuminance = {73.38129496402877, 183.19965870307166};
